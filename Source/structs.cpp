...
//-----------------------------------------------------------------
Linef::Linef()
	: Linef{ 0.0f, 0.0f, 1.0f, 1.0f }
{
}

Linef::Linef(const Point2f& from, const Point2f& to)
	: from{ from }
	, to{ to }
{
}

Linef::Linef(float fromX, float fromY, float toX, float toY)
	: Linef{ Point2f{ fromX, fromY },Point2f{ toX, toY } }
{
}
